    ...
    <section className="bg-[#b32b2b] text-white py-12 px-4 shadow-2xl relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:px-12">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
          <a href="#enquiry-form" className="bg-[#fad400] hover:bg-yellow-400 text-black font-bold py-3.5 px-8 rounded-sm shadow-lg flex items-center justify-center space-x-2 w-full sm:w-auto transition-transform hover:scale-105">
            <Phone className="w-5 h-5 fill-current" />
            <span className="uppercase tracking-wide text-sm">TALK TO COUNSELLOR</span>
          </a>
          
          <a href="#enquiry-form" className="bg-white hover:bg-gray-100 text-black font-bold py-3.5 px-8 rounded-sm shadow-lg flex items-center justify-center space-x-2 w-full sm:w-auto transition-transform hover:scale-105">
